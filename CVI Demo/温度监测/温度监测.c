	...
	switch (event)
	{
		case EVENT_TIMER_TICK:
			...
			if( len )
			{
				...
				{
					SetCtrlVal(panelMain, PANEL_MAIN_LED_CEILING, ATTR_CTRL_VAL, 1);
				}
				else
				{
					SetCtrlVal(panelMain, PANEL_MAIN_LED_CEILING, ATTR_CTRL_VAL, 0);
				}
				if( (float)(data)/10 <= 30.0 )
				{
					SetCtrlVal(panelMain, PANEL_MAIN_LED_FLOOR, ATTR_CTRL_VAL, 1);
				}
				else
				{
					SetCtrlVal(panelMain, PANEL_MAIN_LED_FLOOR, ATTR_CTRL_VAL, 0); 
				} 
