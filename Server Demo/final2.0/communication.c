...
{
	unsigned char transmit_buf[1024] = {0x01, 0x03, 0x0, 0x0, 0x0, 0x02};
...
{
	unsigned char transmit_buf[1024] = {0x02, 0x03, 0x0, 0x0, 0x0, 0x02};
	unsigned int crc[2] = {0};
...
{
	char transmit_buf[1024] = {0x03, 0x03, 0x00, 0x00, 0x00, 0x02};
	unsigned int crc[2] = {0};
