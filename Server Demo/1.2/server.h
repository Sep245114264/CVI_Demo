...
#define  PANEL_CHART_VOLTAGE              17      /* control type: strip, callback function: (none) */
#define  PANEL_TIMERTRANSMIT              18      /* control type: timer, callback function: TimerTransmit */
#define  PANEL_TIMERACCEPT                19      /* control type: timer, callback function: TimerAccept */
...
int  CVICALLBACK TimerAccept(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
