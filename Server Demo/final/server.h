...
#define  PANEL_SAVEPONDING                32      /* control type: command, callback function: CallSavePonding */
#define  PANEL_SAVETEMPERATURE            33      /* control type: command, callback function: CallSaveTemperature */
#define  PANEL_SAVEVOLTAGE                34      /* control type: command, callback function: CallSaveVoltage */
...
#define  PANELSET_TEXTMSG_2               6       /* control type: textMsg, callback function: (none) */
