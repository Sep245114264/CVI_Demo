...
#define  PANEL_TABLE_TEMPERATURE          20      /* control type: table, callback function: (none) */
#define  PANEL_TABLE_PONDING              21      /* control type: table, callback function: (none) */
#define  PANEL_TABLE_VOLTAGE              22      /* control type: table, callback function: (none) */
...
#define  PANEL_CHART_TEMPERATURE          26      /* control type: strip, callback function: (none) */
#define  PANEL_CHART_VOLTAGE              27      /* control type: strip, callback function: (none) */
#define  PANEL_TIMER_SAVE                 28      /* control type: timer, callback function: TimerSave */
#define  PANEL_TIMER_DISPLAY              29      /* control type: timer, callback function: TimerDisplay */
