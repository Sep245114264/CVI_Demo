...
#define  PANEL_SEND_BUTTON                7       /* control type: command, callback function: SendTest */
...
int  CVICALLBACK SendTest(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
